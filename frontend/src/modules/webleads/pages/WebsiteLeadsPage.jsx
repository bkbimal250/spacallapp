    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card">
                {loading ? <LoadingState /> : <WebsiteLeadTable leads={leads} onView={(row) => navigate(`/web-leads/leads/${row.id}`)} onStatus={status} onAssign={setAssigning} canAssign={canAssign} />}
