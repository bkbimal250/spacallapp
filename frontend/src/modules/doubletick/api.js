...
export const doubletickAPI = {
    ...
    manualCorrect: (id, data) => axiosInstance.post(`/doubletick/conversations/${id}/manual-correct/`, data),
    ...
    replyLead: (id, data) => axiosInstance.post(`/doubletick/leads/${id}/reply/`, data),
