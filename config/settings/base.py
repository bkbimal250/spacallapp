...
CALL_ROUTING_WHATSAPP_RECIPIENT_COOLDOWN_HOURS = env.int("CALL_ROUTING_WHATSAPP_RECIPIENT_COOLDOWN_HOURS", default=24)
...
CELERY_TASK_DEFAULT_QUEUE = env("CELERY_TASK_DEFAULT_QUEUE", default="calllog_system")
...
DOUBLETICK_AUTO_REPLY_ENABLED = env.bool("DOUBLETICK_AUTO_REPLY_ENABLED", default=False)
